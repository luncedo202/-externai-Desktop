    ...
    const response = await fetch('https://api.openai.com/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: 'You are a command explainer for non-technical founders. Explain terminal commands and their results in simple, plain English. Focus on what was done and why it matters. Be very brief (2-3 sentences max). No technical jargon. IMPORTANT: If the output contains a URL (like http://localhost:3000), your FIRST line must be: "Click here to open your app: [the URL]". Then explain what happened on the next line.'
          },
          {
            role: 'user',
